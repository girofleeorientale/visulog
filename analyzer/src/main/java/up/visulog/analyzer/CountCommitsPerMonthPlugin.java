...
/**
 * un plugin pour compter le nombre de commits par mois indépendemment des auteurs
 */

public class CountCommitsPerMonthPlugin implements AnalyzerPlugin {
    private final static SimpleDateFormat dateCommitFormat = new SimpleDateFormat("yyyy-MM",Locale.ENGLISH);
    ...
    public CountCommitsPerMonthPlugin() {
    ...
    public String getHelp () {
        return "This plugin counts commits number per month from all authors from repository";
    }

    @Override
    public String getName () {
        return "countCommitsPerMonth";
    }
